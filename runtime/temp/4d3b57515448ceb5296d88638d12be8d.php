<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:89:"D:\Nicmic\wamp64\www\fastadmin\public/../application/index\view\express\address_edit.html";i:1524126953;s:73:"D:\Nicmic\wamp64\www\fastadmin\application\index\view\layout\default.html";i:1523974191;s:70:"D:\Nicmic\wamp64\www\fastadmin\application\index\view\common\meta.html";i:1523974191;s:73:"D:\Nicmic\wamp64\www\fastadmin\application\index\view\common\sidenav.html";i:1524128078;s:72:"D:\Nicmic\wamp64\www\fastadmin\application\index\view\common\script.html";i:1523974191;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="sidenav">
    <ul class="list-group">
        ...
        <li class="list-group-item <?php echo $config['actionname']=='address_add'?'active':''; ?>"> <a href="<?php echo url('express/address'); ?>"><i class="fa fa-user-circle"></i> 地址管理</a> </li>
    </ul>
</div>
        </div>
        <div class="col-md-9">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h2 class="page-header">编辑地址</h2>
                    <form id="address-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
                        <?php echo token(); ?>
                        <div class="form-group">
                            <label for="name" class="control-label col-xs-12 col-sm-2">姓名</label>
                            <div class="col-xs-12 col-sm-4">
                                <input type="text" class="form-control" id="name" name="name" value="<?php echo $data['name']; ?>" data-rule="required" placeholder="姓名">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="mobile" class="control-label col-xs-12 col-sm-2">手机</label>
                            <div class="col-xs-12 col-sm-4">
                                <input type="text" class="form-control" id="mobile" name="mobile" value="<?php echo $data['mobile']; ?>" data-rule="required" placeholder="手机">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="c-city" class="control-label col-xs-12 col-sm-2">城市</label>
                            <div class="col-xs-12 col-sm-8">
                                <div class='control-relative'><input id="c-city" data-rule="required" class="form-control" data-toggle="city-picker" name="city" type="text" value="<?php echo $data['city']; ?>"></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="address" class="control-label col-xs-12 col-sm-2">详细地址</label>
                            <div class="col-xs-12 col-sm-8">
                                <input type="text" class="form-control" id="address" name="address" value="<?php echo $data['address']; ?>" data-rule="required" placeholder="详细地址">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-xs-12 col-sm-2">设为默认</label>
                            <div class="col-xs-12 col-sm-8">
                                <?php echo build_radios('is_default', ['0'=>'否', '1'=>'是'], $data['is_default']); ?>
                            </div>
                        </div>
