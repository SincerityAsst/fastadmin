        ...
        <div class="col-md-9">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h2 class="page-header">地址管理</h2>
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane fade active in" id="one">
                            <div class="widget-body no-padding">
                                <div class="bootstrap-table">
                                    <div class="fixed-table-toolbar" style="margin-bottom: 20px;">
                                        <a href="<?php echo url('express/address_add'); ?>" class="btn btn-success btn-add" title="<?php echo __('Add'); ?>"><i class="fa fa-plus"></i> <?php echo __('Add'); ?></a>
                                    </div>
                                    <div class="fixed-table-container">
                                        <table id="table" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $vo['city']; ?> <?php echo $vo['address']; ?></td>
                                                <td><?php if($vo['is_default'] == '1'): ?>是<?php else: ?>否<?php endif; ?></td>
                                                <td style="text-align: center; vertical-align: middle; ">
                                                    <a href="<?php echo url('express/address_edit',['id'=>$vo['id']]); ?>" class="btn btn-xs btn-success btn-editone" title="编辑"><i class="fa fa-pencil"></i></a>
                                                    <a href="<?php echo url('express/address_del',['id'=>$vo['id']]); ?>" class="btn btn-xs btn-danger btn-delone" title="删除" ><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
