<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"D:\Nicmic\wamp64\www\fastadmin\public/../application/admin\view\index\login.html";i:1523974191;s:70:"D:\Nicmic\wamp64\www\fastadmin\application\admin\view\common\meta.html";i:1523974191;s:72:"D:\Nicmic\wamp64\www\fastadmin\application\admin\view\common\script.html";i:1523974191;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
                            ...
                            <form action="" method="post" id="login-form">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon" style="padding:0;border:none;cursor:pointer;">
                                        <img src="<?php echo rtrim('/fastadmin/public/', '/'); ?>/captcha" width="100" height="30" onclick="this.src = '<?php echo rtrim('/fastadmin/public/', '/'); ?>/captcha?r=' + Math.random();"/>
                                    </span>
                                </div>
                                <?php endif; ?>
